...
-- Lock Database
UPDATE PUBLIC.DATABASECHANGELOGLOCK SET LOCKED = TRUE, LOCKEDBY = 'pims (172.19.0.10)', LOCKGRANTED = '2023-08-04 21:53:10.418' WHERE ID = 1 AND LOCKED = FALSE;
